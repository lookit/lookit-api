...
from studies.helpers import get_absolute_url, send_mail
...
class Message(models.Model):
    ...
    def email_headers(cls, context):
        ...
        if token and username:
            email_unsubscribe_link = get_absolute_url(
                reverse(
            ...
            return {
                ...
                "List-Unsubscribe": f"<mailto:lookit-bot@mit.edu>, <{email_unsubscribe_link}>",
            }
        else:
            return None
