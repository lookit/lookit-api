...
STUDY_HELP_TEXT_EDIT = (STUDY_HELP_TEXT_INITIAL +
...
class StudyEditForm(BaseStudyForm):
    ...
    class Meta:
        ...
        help_texts = {
            ...
            "contact_info":
                "This should give the name of the PI for your study, and an email address where the PI or study staff can be reached with questions. Format: PIs Name (contact: youremail@lab.edu)",
            "criteria":
