...
def get_url_without_trailing_slash(url):
    # Remove the trailing slash from URL. This is used to modify the BASE_URL from project settings when we're constructing a full URL by concatenating with the rest of the path (e.g. the path generated by the url template tag).
...
def send_mail(
    ...
    **context,
    ...
    """
    context["base_url"] = get_url_without_trailing_slash(BASE_URL)
